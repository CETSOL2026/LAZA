      ...
      return <article key={pipelineCode} className="overflow-hidden rounded-2xl border border-border bg-white shadow-sm transition-shadow hover:shadow-md">
        <div className="p-6">
          ...
          <div className="mt-6 flex gap-2">
            {canDownload
              ? <a href={sourceDownloadUrl(primary)} className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm text-white transition-colors hover:bg-primary/90"><Download className="h-4 w-4" />{files.length === 1 ? 'Download source file' : 'Download latest file'}</a>
